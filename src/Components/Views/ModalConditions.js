        ...
        <View style={{ flex: 1 }}>
          ...
          <ScrollView indicatorStyle="black" style={styles.body}>
            <Text accessible={true} style={styles.conditions}>
              ...
              constituida bajo las leyes de la República Oriental del Uruguay con domicilio en la ciudad de
              Montevideo.
              {'\n'}1.2. Es la única titular de los derechos de propiedad intelectual e industrial sobre el sitio web
              https://gs1uy.org y el nombre de dominio “gs1uy.org”. Asimismo, cuenta con las licencias necesarias
              para hacer disponibles a los usuarios y permitir el uso de la aplicación “Etiqueta Virtual (EV)” y las
              marcas y logotipos que lucen en ellas.
              {'\n'}1.3. “Etiqueta Virtual (EV)” (“La Aplicación”) es una aplicación exclusivamente orientada a
              dispositivos (sistemas operativos Android e IOS), que se descarga gratuitamente desde Google Play o
              Apple Store, la cual permite a un usuario consultar información sobre un producto, leyendo su código de
              barras.
              {'\n'}
              {'\n'}2. Objeto
              {'\n'}2.1. La utilización de “Etiqueta Virtual (EV)” implica el íntegro conocimiento y aceptación de
              estos “Términos y Condiciones de Uso”. Cualquier modificación tendrá validez desde la debida
              notificación según lo establecido en este documento.
              {'\n'}2.2. Los “Términos y Condiciones de Uso” tienen carácter obligatorio y vinculante. Toda persona
              que no esté de acuerdo con ellos deberá abstenerse de utilizar la Aplicación.
              ...
              {'\n'}3.4. “Etiqueta Virtual (EV)” es una aplicación diseñda para funcionar en dispositivos móviles,
              con sistemas operativos Android o IOS, que se puede descargar desde Google Play o de la Appstore de
              Apple. La aplicación, permite utilizar la cámara del dispositivo móvil para leer el código de barras
              que identifica los productos y devolver la información que la empresa proveedora de los mismos haya
              cargado en el catálogo Rondanet. La información de los productos se mostrará en la pantalla y podrá ser
              reproducida en forma oral utilizando la funcionalidad “Texto a Voz”, incorporada como herramienta de
              accesibilidad en cada dispositivo.
              {'\n'}3.5. “Código de Barras es el símbolo que representa al código GTIN que identifica a los productos
              y que está formado por una secuencia de barras de difrente grosor, generalmente de color oscuro sobre
              fondo claro. Se le llama GTIN (Global Trade Item Number) al número que identifica de forma única,
              global y no ambigua a todos los productos registrados bajo el estándar GS1. Cada GTIN diferente tiene
              asociado un código de barras distinto, el que es leído por la aplicación EV para acceder al catálogo
              Rondanet y extraer la información correspondiente.
              ...
              catálogo Rondanet es cargada y mantenida exclusivamente por la empresa proveedora. 3.7. Sistema “Texto
              a Voz” es una de las herramientas de accesibilidad que tienen incorporada los sistemas oprativos
              Android e IOS. Esta funcionalidad se encarga de describir en voz alta las acciones que se relizan en el
              ...
              {'\n'}4.1. Mediante la Aplicación “Etiqueta Virtual (EV)” el usuario podrá consultar la información de
              un producto, leyendo su código de barras. Para mostrarle al usuario la información de un producto, la
              ...
              correspondiente en el catálogo Rondanet, al leer el código de barras del producto, la aplicación no
              podrá devolver ningún atributo.
              {'\n'}4.2. “Etiqueta Virtual (EA)” no recoge datos personales de los usuarios de la aplicación. Sin
              perjuicio de ello, si fuere necesario recolectar y tratar datos personales de los usuarios, sólo se
              hará respecto a los datos de los usuarios que brinden su consentimiento, tratándose únicamente para la
              finalidad y con la modalidad prevista en este documento y en la Política de Privacidad.
              {'\n'}4.3. “Etiqueta Virtual (EA)” no cederá datos personales de los usuarios a terceros, reservándose
              la posibilidad de tratar la información recogida para ser utilizada en otros servicios y aplicaciones
              de la propia Asociación. Los datos podrán alojarse en servidores de la empresa o de terceros, los que
              contarán con las medidas de seguridad físicas y lógicas adecuadas, permitiéndose el acceso sólo a
              personal autorizado.
              ...
              los presentes “Términos y Condiciones de Uso” haciendo click en el botón “Acepto”, quedando así
              aceptadas todas las condiciones y términos aquí expresados.
              ...
              usuarios. Solo pone en su conocimiento la información que previamente ha cargado la empresa proveedora
              en el Catálogo Rondanet. La empresa proveedora de los productos en el Catálogo Rondanet es la única
              responsable por la veracidad, exactitud y vigencia de la información cargada en la Aplicación y
              ...
              {'\n'}6.2. Las obras referidas están protegidas por tratados internacionales de derecho de autor,
              marca, patente, modelos y diseños industriales. El uso indebido y la reproducción total o parcial de
              dichos contenidos quedan prohibidos, salvo autorización expresa y escrita de “GS1 Uruguay”.
              {'\n'}6.3. Cualquier violación por parte del usuario, implicará su responsabilidad directa y personal
              por los actos practicados, aparejando las responsabilidades civiles y penales pertinentes.
              {'\n'}6.4. El usuario se compromete a no reproducir, copiar el software utilizado o el material que
              deja disponible “Etiqueta Virtual (EA)” para cualquier fin no expresamente autorizado en el presente
              acuerdo, sin autorización por escrito.
              {'\n'}6.5. Queda especialmente prohibido al usuario, además de lo ya establecido en este documento,
              usar la Aplicación para fines diferentes a los que se encuentran específicamente autorizados.
              ...
              Virtual (EV)”, tales como hackers que accedan a la información para cualquier fin. “GS1 Uruguay”
              declara tener cuidados razonables para evitar el acceso indebido a la Aplicación, pero no se hace
              responsable y no puede hacerse responsable por su inviolabilidad.
              ...
              {'\n'}8.4. En caso de que uno o más usuarios o algún tercero inicien cualquier tipo de reclamo o
              acciones legales contra otro usuario, todos y cada uno de los usuarios involucrados en dichos reclamos
              o acciones, eximen de toda responsabilidad a “GS1 Uruguay” y a sus directores, gerentes, empleados,
              ...
              Aplicación. Por lo cual, el usuario renuncia a realizar cualquier acción judicial o extrajudicial
              contra “GS1 Uruguay” que tenga como fundamento la utilización de la Aplicación.
              {'\n'}8.6. “GS1 Uruguay” no se responsabiliza de manera alguna por las decisiones personales,
              comerciales, empresariales, laborales o de cualquier otra índole que pueda tomar el usuario en base a
              ...
              {'\n'}9.2. “GS1 Uruguay” se reserva el derecho de suspender el uso de la Aplicación o bloquear el
              acceso a la misma, según su exclusivo criterio.
              {'\n'}
              {'\n'}10. Condiciones generales
              {'\n'}10.1. “GS1 Uruguay” no se hace responsable del contenido, ni políticas y prácticas de privacidad
              de los sitios que hacen publicidad u ofertan en “Etiqueta Virtual (EV)” y aquellos en los cuales
              “Etiqueta Virtual (EV)” aparece.
