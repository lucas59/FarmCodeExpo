      ...
      <View style={{ flex: 1 }}>
        ...
        <ScrollView indicatorStyle="black" style={styles.body}>
          <Text accessible={true} style={styles.conditions}>
            ...
            minus nobis non, cumque iste numquam fugiat et dignissimos debitis similique dolore ad reiciendis beatae
            assumenda fuga! In. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Error atque, corrupti
            praesentium repudiandae aspernatur assumenda sit? Ipsa minima excepturi et vero tempore, dolores tempora
            sed magni nobis eius, dolor reprehenderit! Lorem ipsum dolor sit amet consectetur adipisicing elit. Error
            culpa voluptatum eius, earum cumque beatae doloremque repudiandae excepturi, necessitatibus aut
            explicabo? Doloremque eius accusamus nihil pariatur nisi eos, saepe id.
          </Text>
        </ScrollView>
